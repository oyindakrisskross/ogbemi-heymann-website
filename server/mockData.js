...
].map(([slug, title, year, dimensions, material, series, available, imageUrl]) => ({
  id: slug,
  slug,
  title,
  year,
...
export const exhibitions = [
  {
    ...
    materials: [{ id: 1, label: "Press Release", fileUrl: "/downloads/available-works-catalogue.txt" }]
  },
  {
    id: 2,
    ...
    works: works.slice(4, 12),
    materials: [{ id: 2, label: "Exhibition Catalogue", fileUrl: "/downloads/available-works-catalogue.txt" }]
  },
  {
    id: 3,
  ...
  },
  {
    ...
    location: {
      ...
      streetAddress: "8 Herbert Macaulay Way",
      city: "Lagos",
      state: "Lagos",
      country: "Nigeria"
    },
...
export const downloadableFiles = [
  { id: 1, label: "Artist CV", fileUrl: settings.cvFileUrl, context: "cv" },
  { id: 2, label: "Available Works Catalogue", fileUrl: settings.catalogueFileUrl, context: "catalogue" }
];
